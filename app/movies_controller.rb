...
def can_be_found_updated_and_saved
  ...
  nu_movie = Movie.find_by(title: "Awesome Flick")
  nu_movie.title = "Even Awesomer Flick"
  nu_movie.save
end
...
def can_update_using_update_method
  ...
  nu_movie = Movie.find_by(title: "Wat?")
  nu_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  trash = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  trash.destroy
end
