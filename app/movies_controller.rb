...
def can_be_created_in_a_block
  Movie.create do |m|
    m.title = "something"
    m.release_date = "something"
    m.director = "something"
    m.lead = "something"
    m.in_theaters = "something"
  end
end
...
def can_be_found_updated_and_saved
  ...
  movie_instance = Movie.find_by(title: "Awesome Flick")
  movie_instance.title = "Even Awesomer Flick"
  movie_instance.save
end

def can_update_using_update_method
  Movie.create(title: "Wat?")
  movie_instance = Movie.find_by(title: "Wat?")
  movie_instance.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  movie_instance = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
