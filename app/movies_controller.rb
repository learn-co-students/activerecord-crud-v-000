...
def can_update_multiple_items_at_once
  ...
  5.times do |i|
    ...
    Movie.all.collect {|m| m.update(title: "A Movie")}
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  this_id = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  Movie.destroy(this_id)
end
...
def can_destroy_all_items_at_once
  ...
  Movie.all.each {|m| Movie.destroy(m)}
end
