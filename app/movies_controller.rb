...
def can_get_size_of_the_database
  movies_size=Movie.all.length
end

def can_find_the_first_item_from_the_database_using_id
  can_find_the_first_item_from_the_database_using_id=Movie.find_by id: 1
  can_find_the_first_item_from_the_database_using_id.title
end
...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000,
  # director == "Me"
  can_find_by_multiple_attributes=Movie.find_by(title: "Title", release_date: 2000, director: "Me")
end

def can_find_using_where_clause_and_be_sorted
  # For this test return all movies released after 2002 and ordered by
  # release date descending
  can_find_using_where_clause_and_be_sorted=Movie.where("release_date >2002").order(release_date: :DESC)
end
