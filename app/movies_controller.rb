...
def can_be_found_updated_and_saved
  ...
  test = Movie.find_by title: "Awesome Flick"
  test.title = "Even Awesomer Flick"
  test.save
end
...
def can_update_using_update_method
  ...
  test = Movie.find_by title: "Wat?"
  test.update(title: "Wat, huh?")
end
...
def can_update_multiple_items_at_once
  ...
  Movie.all.each do |t|
    t.update(title: "A Movie")
  end
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  test = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  test.destroy
end
