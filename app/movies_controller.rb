...
def can_be_found_updated_and_saved
  ...
  target_movie = Movie.find_by(title: "Awesome Flick")
  target_movie.title = "Even Awesomer Flick"
  target_movie.save
end
...
def can_update_using_update_method
  ...
  target_movie = Movie.find_by(title: "Wat?")
  target_movie.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  target_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
