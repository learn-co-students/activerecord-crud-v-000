...
def can_be_found_updated_and_saved
  ...
  movie_title = Movie.find_by title: "Awesome Flick"
  movie_title.update(title: "Even Awesomer Flick")
  movie_title.save
end
...
def can_update_using_update_method
  ...
  movie_title = Movie.find_by title: "Wat?"
  movie_title.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  movie_title = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  movie_title.destroy
end
