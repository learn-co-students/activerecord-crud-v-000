...
def can_be_found_updated_and_saved
  ...
  moo = Movie.find_by_title("Awesome Flick")
  moo.title = "Even Awesomer Flick"
  moo.save
end
...
def can_update_using_update_method
  ...
  moo = Movie.find_by_title("Wat?")
  moo.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  moo = Movie.find_by_title("That One Where the Guy Kicks Another Guy Once")
  moo.destroy
end
