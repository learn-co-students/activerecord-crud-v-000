...
def can_get_size_of_the_database
  Movie.last.id #not truly size, could collect all and count?
end
...
def can_be_found_updated_and_saved
  ...
  foo = Movie.find_by title: "Awesome Flick"
  foo.update title: "Even Awesomer Flick"
  foo.save
end
...
def can_update_using_update_method
  ...
  foo = Movie.find_by title: "Wat?"
  foo.update title: "Wat, huh?"
end
...
def can_destroy_a_single_item
  ...
  foo = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  foo.destroy
end
