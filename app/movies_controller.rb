...
def can_be_created_in_a_block(args = {title: "Home Alone", release_date:1990}) #Should I declare args as an empty hash as a default?
  # binding.pry #=> "self" here is RSpec

  #QUESTION: The first test expects a result of a move.title and move.release_date to have values
  #But where are those values declared if no args are passed in?
  Movie.create do |m|
    m.title = args[:title]
