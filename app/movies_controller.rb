...
def can_find_the_first_item_from_the_database_using_id
  Movie.find(1).title
  #Using the find method, you can retrieve the object corresponding to the specified primary key that matches any supplied options. For example:     # Find the client with primary key (id) 10.
