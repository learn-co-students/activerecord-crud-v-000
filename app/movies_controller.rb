...
def can_destroy_a_single_item
  Movie.create(title: "Tafsdfasdfhat One Where the Guy Kicks Another Guy Once")
  mov = Movie.find_by(title: "Tafsdfasdfhat One Where the Guy Kicks Another Guy Once")
  mov.destroy
end
