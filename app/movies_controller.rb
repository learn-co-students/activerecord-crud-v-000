...
def can_find_by_different_attributes
  ...
  Movie.where(release_date: 2000).take!
  Movie.where(director: "Me").take!
end
...
def can_be_found_updated_and_saved
  ...
  movie = Movie.where(title: "Awesome Flick")[0]
...
def can_destroy_a_single_item
  ...
  Movie.where(title: "That One Where the Guy Kicks Another Guy Once")[0].destroy
end
